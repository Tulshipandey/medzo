...
export default function ChemistLoginPage() {
  return (
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Chemist Login</h1>
          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter your chemist ID or email"
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/chemist/forgot-password" className="text-sm text-blue-600 hover:text-blue-700">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/partner/apply" className="text-blue-600 hover:text-blue-700 font-medium">
                Apply Now
              </Link>
            </p>
          </div>
