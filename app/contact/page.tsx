          ...
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@medswift.com</p>
                    <p className="text-gray-600">info@medswift.com</p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-xl p-6 border-2 border-blue-100">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <p className="mt-4 font-semibold text-blue-600">24/7 Emergency Support Available</p>
              </div>
            </div>
          </div>
